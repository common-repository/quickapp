...
<body> 
   ...
   <div data-role="page" id="pgCategories" class="mPage">
        ...
        <div id="header" data-theme="a" data-role="header" data-position="fixed">
        	<a data-role="button" data-direction="reverse" data-rel="back" data-transition="none" href="#" data-icon="back" data-iconpos="left" 
	...
	<?php endif; ?>
        ...
        <div data-role="footer" class="mFooter" data-position="fixed">
        	<div class="pageOptions" data-role="navbar">
                <ul>
                    <li>
                    	<a href="<?php echo esc_url( home_url( '/' ).'?share' ); ?>" data-rel="dialog" data-transition="none"><img src="<?php echo plugins_url('images/share.png', dirname(__FILE__)); ?>" alt=""></a>
                    </li>
                    <li>
                        <a href="<?php echo esc_url( home_url( '/' ).'?post/comments/&id='.get_the_ID() ); ?>" data-direction="reverse" data-transition="none" ><img src="<?php echo plugins_url('images/comments.png', dirname(__FILE__)); ?>" alt=""></a>
                    </li>
                    <li>
                        <a href="#" data-transition="none" id="lnkPages" class="fontChanger">
