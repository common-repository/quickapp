...
<?php if($page_num > 1): ?>            
            <a href="?archives/list/<?php echo $page_num-1; ?>" data-role="button" data-icon="arrow-l" data-iconpos="notext" data-theme="b" data-inline="true" data-transition="none" data-direction="reverse">Previous</a>
<?php else: ?>
            <a style="display: none;" ></a>    
<?php endif; ?>	    	    
		<h1>Monthly Archives</h1>
<?php if($page_num < $total_pages):  ?>		
		<a href="?archives/list/<?php echo $page_num+1; ?>" data-role="button" data-icon="arrow-r" data-iconpos="notext" data-theme="b" data-inline="true" data-transition="none">Next</a>
<?php endif;   ?>		
	</div><!-- /header -->
